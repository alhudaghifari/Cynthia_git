...
public class RecyclerResultSearch extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private static String TAG = RecyclerResultSearch.class.getSimpleName();

    private Context mContext;

    private List<DbDataFashion> mDbDataFashionList;

    public RecyclerResultSearch(Context context, List<DbDataFashion> dbDataFashions) {
        mContext = context;
